<template>
  <q-page-container style="padding: 0px;">
    <q-page class="bg-teal-1">
      <q-card class="measurement-card bg-teal-1">
            ...
            <q-markup-table class="bg-teal-1">
              ...
              <tbody>
                <tr v-for="measurement in measurements" v-bind:key="measurement.properties.bore_id" @click="selectMeasurement(measurement)">
                  ...
                  <td class="text-center" style="font-size:10px">{{ measurement.properties.instrument }}</td>
                  <td class="text-center" style="font-size:10px">{{ measurement.properties.chemical_id }}</td>
                  <td class="text-center" style="font-size:10px">{{ measurement.properties.measurement_value }}</td>
                  <td class="text-center" style="font-size:10px">{{ measurement.properties.units }}</td>
